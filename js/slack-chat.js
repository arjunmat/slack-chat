...
(function( $ ) {
    ...
    var methods = {
        ...
        clientPrivateChat: false, //Only show the client their messages and slack messages w/ botUser name in them
        isOpen: false,
        badgeElement: false,
                        ...
                        if(resp.ok && resp.messages.length) {
                            ...
                            for(var i=0; i< resp.messages.length; i++)
                            {
                                ...
                                if(resp.messages[i].subtype == 'bot_message' && resp.messages[i].text !== "") {
                                    ...
                                    if (window.slackChat._options.clientPrivateChat == true){
                                        if (messageText.indexOf(options.botUser) >= 0 || options.botUser == userName) {
                                    ...
                                    if (window.slackChat._options.clientPrivateChat == true){
                                        if (messageText.indexOf(options.botUser) >= 0) {
                                            html = slackMessageHTML();
                                        }
                                    } else {
                                        html = slackMessageHTML();
                                    }
